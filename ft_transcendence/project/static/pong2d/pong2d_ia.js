...
var Game = {
    ...
    endMatch: function (winner) {
        ...
        let winnerId = winner === 'player' ? window.playerId : 'AI';
    
        if (!window.playerId || !window.matchId) {
            console.error('Missing playerId or matchId');
            return;
        }
        ...
        .then(data => {
            if (data.status === 'success') {
                ...
                window.location.href = winner === 'player' ? '/pong2d_success/' : '/pong2d_failure/';
            } else {
