(function() {
    ...
    var Game = {
        ...
        endMatch: function (winner) {
            ...
            fetch('/pongapi2d_tournament_match_end/', {
                method: 'POST',
                headers: {
            ...
            .then(data => {
                if (data.status === 'success') {
                    console.log('Match result sent to tournament application:', data);
                    window.location.href = `/tournament_api_details/${window.tournamentId}/`;
                } else {
